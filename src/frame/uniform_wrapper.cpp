...
void UniformWrapper::SetValueInt(const std::string& name, const std::vector<std::int32_t>& vector,
                                 glm::uvec2 size) {
...
std::vector<std::int32_t> UniformWrapper::GetValueInt(const std::string& name) const {
