...
class DeviceInterface {
   public:
     ...
     */
    virtual void AddPlugin(std::unique_ptr<PluginInterface>&& plugin_interface) = 0;
    /**
     ...
     * @param static_mesh_parameter: A struct containing the parameters to create a static mesh.
