...
class UniformInterface {
   public:
     ...
     */
    virtual void SetValueFloat(const std::string& name, const std::vector<float>& vector,
                               glm::uvec2 size) = 0;
    /**
     * @brief Set value int.
     * @param name: Connection name.
     ...
     * @param size: The size of the vector.
     */
    virtual void SetValueInt(const std::string& name, const std::vector<std::int32_t>& vector,
                             glm::uvec2 size) = 0;
    /**
     ...
     * @return The vector that correspond to the value.
     */
    virtual std::vector<std::int32_t> GetValueInt(const std::string& name) const = 0;
    /**
